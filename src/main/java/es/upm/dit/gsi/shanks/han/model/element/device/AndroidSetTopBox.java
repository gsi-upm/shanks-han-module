 ...
 * es.upm.dit.gsi.shanks.han.model.element.device.AndroidSetTopBox.java
 * 
...
public class AndroidSetTopBox extends SetTopBox {
	 ...
	 * @param logger
	 */
	public AndroidSetTopBox(String id, String initialState, boolean isGateway, Logger logger) {
