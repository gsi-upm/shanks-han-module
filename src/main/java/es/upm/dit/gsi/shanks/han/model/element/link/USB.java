 ...
 * File: es.upm.dit.gsi.shanks.han.model.element.link.USBLink.java
 * 
...
public class USB extends Link {
	 ...
	 */
	public USB(String id, String initialState, int capacity, Logger logger)
			throws ShanksException {
